...
public:
    ...
    {
        TextScreenField->setWindowTitle(QApplication::translate("TextScreenField", "Form", nullptr));
        upperLabel->setText(QApplication::translate("TextScreenField", "Add variables that the user may use for this observer", nullptr));
        labelGeneral->setText(QApplication::translate("TextScreenField", "Default variables", nullptr));
        labelToBeUse->setText(QApplication::translate("TextScreenField", "Variables to be used:", nullptr));
        selectDefault->setText(QApplication::translate("TextScreenField", "Select All", nullptr));
        selectUse->setText(QApplication::translate("TextScreenField", "Select All", nullptr));
        add->setText(QApplication::translate("TextScreenField", "+", nullptr));
        del->setText(QApplication::translate("TextScreenField", "-", nullptr));
        QTableWidgetItem *___qtablewidgetitem = defaultVarList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("TextScreenField", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = defaultVarList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("TextScreenField", "Label", nullptr));
        rButton->setText(QApplication::translate("TextScreenField", "...", nullptr));
        lButton->setText(QApplication::translate("TextScreenField", "...", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = useVarList->horizontalHeaderItem(0);
        ___qtablewidgetitem2->setText(QApplication::translate("TextScreenField", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = useVarList->horizontalHeaderItem(1);
        ___qtablewidgetitem3->setText(QApplication::translate("TextScreenField", "Label", nullptr));
#ifndef QT_NO_TOOLTIP
        container->setToolTip(QApplication::translate("TextScreenField", "Default value", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
