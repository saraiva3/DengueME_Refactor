...
public:
    ...
    {
        DescriptionWindow->setWindowTitle(QApplication::translate("DescriptionWindow", "Help", nullptr));
        pushButton->setText(QApplication::translate("DescriptionWindow", "Ok", nullptr));
    } // retranslateUi
