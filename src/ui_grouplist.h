...
public:
    ...
    {
        GroupEditor->setWindowTitle(QApplication::translate("GroupEditor", "GroupEditor", nullptr));
        addGroup->setText(QApplication::translate("GroupEditor", "Add group", nullptr));
    } // retranslateUi
