...
void DirModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DirModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DirModel::aboutToUpdate)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DirModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DirModel::updated)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DirModel::staticMetaObject = {
    { &QStandardItemModel::staticMetaObject, qt_meta_stringdata_DirModel.data,
      qt_meta_data_DirModel,  qt_static_metacall, nullptr, nullptr}
};
