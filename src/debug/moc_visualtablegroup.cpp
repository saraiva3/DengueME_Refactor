...
void VisualTableGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: { VisualTableField* _r = _t->addVariable();
            if (_a[0]) *reinterpret_cast< VisualTableField**>(_a[0]) = std::move(_r); }  break;
        ...
        {
            using _t = void (VisualTableGroup::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VisualTableGroup::heightChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VisualTableGroup::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_VisualTableGroup.data,
      qt_meta_data_VisualTableGroup,  qt_static_metacall, nullptr, nullptr}
};
