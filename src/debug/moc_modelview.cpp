...
QT_MOC_LITERAL(9, 95, 3), // "add"
QT_MOC_LITERAL(10, 99, 3) // "del"

    },
    "ModelView\0interpreterChanged\0\0Interpreter\0"
    "addFile\0removeFile\0renameFile\0"
    "onInterpreterChanged\0r\0add\0del"
};
...
void ModelView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ModelView::*)(Interpreter );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModelView::interpreterChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ModelView::staticMetaObject = {
