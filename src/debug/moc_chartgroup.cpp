...
void ChartGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: { ChartField* _r = _t->addVariable();
            if (_a[0]) *reinterpret_cast< ChartField**>(_a[0]) = std::move(_r); }  break;
        ...
        {
            using _t = void (ChartGroup::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartGroup::heightChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ChartGroup::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_ChartGroup.data,
      qt_meta_data_ChartGroup,  qt_static_metacall, nullptr, nullptr}
};
