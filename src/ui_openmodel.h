...
public:
    ...
    void retranslateUi(QDialog *OpenModel)
    {
        ...
        label->setText(QApplication::translate("OpenModel", "<html><head/><body><p><span style=\" font-size:xx-large; font-weight:600;\">Personal library of models</span><br/>Select the model to be opened</p></body></html>", nullptr));
        ok->setText(QApplication::translate("OpenModel", "Open", nullptr));
