...
public:
    ...
    {
        ObserversList->setWindowTitle(QApplication::translate("ObserversList", "ObserverEditor", nullptr));
        addObserver->setText(QApplication::translate("ObserversList", "Add observer", nullptr));
    } // retranslateUi
