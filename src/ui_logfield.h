...
public:
    ...
    {
        LogField->setWindowTitle(QApplication::translate("LogField", "Form", nullptr));
        labelFilename->setText(QApplication::translate("LogField", "File name:", nullptr));
#ifndef QT_NO_TOOLTIP
        fileName->setToolTip(QApplication::translate("LogField", "label", nullptr));
#endif // QT_NO_TOOLTIP
        fileName->setText(QString());
        fileName->setPlaceholderText(QApplication::translate("LogField", "File name...", nullptr));
        labelSeparator->setText(QApplication::translate("LogField", "Separator", nullptr));
        separator->setItemText(0, QApplication::translate("LogField", ",", nullptr));
        separator->setItemText(1, QApplication::translate("LogField", ".", nullptr));
        separator->setItemText(2, QApplication::translate("LogField", "|", nullptr));
        separator->setItemText(3, QApplication::translate("LogField", ";", nullptr));

        overwrite->setText(QApplication::translate("LogField", "Overwrite?", nullptr));
        upperLabel->setText(QApplication::translate("LogField", "Add variables that the user may use for this observer", nullptr));
        labelGeneral->setText(QApplication::translate("LogField", "Default variables:", nullptr));
        labelToBeUse->setText(QApplication::translate("LogField", "Variables to be used:", nullptr));
        selectDefault->setText(QApplication::translate("LogField", "Select all", nullptr));
        selectUse->setText(QApplication::translate("LogField", "Select all", nullptr));
        add->setText(QApplication::translate("LogField", "+", nullptr));
        del->setText(QApplication::translate("LogField", "-", nullptr));
        QTableWidgetItem *___qtablewidgetitem = defaultVarList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("LogField", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = defaultVarList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("LogField", "Label", nullptr));
        rButton->setText(QApplication::translate("LogField", "...", nullptr));
        lButton->setText(QApplication::translate("LogField", "...", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = useVarList->horizontalHeaderItem(0);
        ___qtablewidgetitem2->setText(QApplication::translate("LogField", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = useVarList->horizontalHeaderItem(1);
        ___qtablewidgetitem3->setText(QApplication::translate("LogField", "Label", nullptr));
#ifndef QT_NO_TOOLTIP
        container->setToolTip(QApplication::translate("LogField", "Default value", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
